...
const about = ({themeUse,theme}) => {
    const content = {
        Description: "Xin chào, tớ là Khoa Nguyễn (yun.khngn), sinh viên tại Đại học FPT, chuyên ngành Công nghệ thông tin. Hiện tại tớ đang là freelancer thiết kế đồ hoạ và phát triển một số dự án cá nhân liên quan tới chuyên ngành của mình. Ngoài ra, tớ còn là guitarist của ban nhạc Giấy Trắng ở Hà Nội.",
        Content: "Tớ sinh ra tại Nam Định (quê hương tớ) và lớn lên, học tập tại Hà Nội. Bén duyên với cái ngành này cũng là do từ bé đã có sở thích với mấy cái hay ho. Tớ thích tìm hiểu về những thứ mới mẻ, thử thách bản thân và không ngừng học hỏi (phương châm của tớ là làm nhưng hãy làm tốt hơn). Tớ cũng thích chơi guitar, đọc sách, xem phim và nhiếp ảnh, quay phim. Tuy rằng hơi bận rộn nhưng tớ vẫn cố gắng dành thời gian cho những sở thích của mình, tập đàn 5 tiếng mỗi ngày, hay là ngồi code cả tối, dành thời gian cho người yêu siêu nhiều. Thôi cũng chẳng biết viết gì hơn nữa, tạm kết ở đây nha!",
      }
    return (
