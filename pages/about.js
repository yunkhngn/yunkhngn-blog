...
const about = ({themeUse,theme}) => {
    const content = {
        Description: "Xin chào, tớ là Khoa Nguyễn (yun.khngn). Tớ là sinh viên chuyên ngành Công nghệ thông tin tại Đại học FPT. Hiện tại tớ đang là freelancer thiết kế đồ hoạ và phát triển một số dự án cá nhân liên quan tới chuyên ngành. Ngoài ra, tớ còn là guitarist của ban nhạc Giấy Trắng ở Hà Nội.",
