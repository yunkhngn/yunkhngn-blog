...
export default function Metatags({description}) {
    return (
        <Head>
            ...
            <meta name="description" content={(description.desc) ? description.desc : "Xin chào, tớ là Khoa Nguyễn. Tớ đang là sinh viên chuyên ngành Công nghệ thông tin tại Đại học FPT. Hiện tại tớ cũng đang là freelancer thiết kế đồ hoạ và phát triển một số dự án cá nhân liên quan tới chuyên ngành của mình."}/>
            ...
            <meta property="og:description" content={description.desc || "Xin chào, tớ là Khoa Nguyễn. Tớ đang là sinh viên chuyên ngành Công nghệ thông tin tại Đại học FPT. Hiện tại tớ cũng đang là freelancer thiết kế đồ hoạ và phát triển một số dự án cá nhân liên quan tới chuyên ngành của mình."} />
            ...
            <meta property="twitter:description" content={(description.desc) ? description.desc : "Xin chào, tớ là Khoa Nguyễn. Tớ đang là sinh viên chuyên ngành Công nghệ thông tin tại Đại học FPT. Hiện tại tớ cũng đang là freelancer thiết kế đồ hoạ và phát triển một số dự án cá nhân liên quan tới chuyên ngành của mình."}/>
