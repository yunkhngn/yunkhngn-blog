const desc = {
    home: {
        ...
        img: 'https://yunkhngn.dev/image/thumbnail.jpg',
        content : "Xin chào, tớ là Khoa Nguyễn (yun.khngn), sinh viên chuyên ngành Kỹ thuật phần mềm tại Đại học FPT. Tớ đang là freelancer thiết kế đồ hoạ và là một guitarist. Tớ đang hướng tới trở thành một Fullstack Developer và thực hiện thêm nhiều ước mơ phía trước."
    },
    about: {
        title: 'Giới thiệu | Khoa Nguyễn',
        heading: 'Giới thiệu',
        url: 'https://yunkhngn.dev/about',
        route: '/about',
        desc: "Một chút điều thú vị về tớ và những điều lớn lao.",
        img: 'https://yunkhngn.dev/image/thumbnail.jpg',
        content: {
            Description: "Xin chào, tớ là Khoa Nguyễn (yun.khngn), sinh viên chuyên ngành Kỹ thuật phần mềm tại Đại học FPT. Tớ đang là freelancer thiết kế đồ hoạ và là một guitarist. Tớ đang hướng tới trở thành một Fullstack Developer và thực hiện thêm nhiều ước mơ phía trước.",
    ...
    projects: {
        title: 'Dự án | Khoa Nguyễn',
        heading: 'Dự án',
        url: 'https://yunkhngn.dev/project',
        route: '/project',
    ...
    pics: {
        ...
        heading: 'Thư viện',
        url: 'https://yunkhngn.dev/library',
        route: '/library',
    ...
    blog: {
        ...
        heading: 'Viết linh tinh',
        url: 'https://yunkhngn.dev/writing',
        route: '/writing',
    ...
    contact: {
        ...
        heading: 'Liên hệ',
        url: 'https://yunkhngn.dev/contact',
        route: '/contact',
    ...
    resume: {
        ...
        heading: 'Resume',
        url: 'https://yunkhngn.dev/business/resume',
    ...
    changeLog: {
        ...
        heading: 'Change log',
        url: 'https://yunkhngn.dev/change-log',
